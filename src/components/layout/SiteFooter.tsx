        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/guides/escape-winter" className="hover:text-soulo-white transition-colors">Escape the Winter</Link></li>
              <li><Link href="/guides/winter-wonderland" className="hover:text-soulo-white transition-colors">Winter Wonderland</Link></li>
            </ul>
          </div>
