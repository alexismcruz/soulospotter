...
const countries = [
  { name: "United States", slug: "united-states", code: "US", region: Region.NORTH_AMERICA, flagEmoji: "ðŸ‡ºðŸ‡¸" },
  { name: "Mexico", slug: "mexico", code: "MX", region: Region.LATIN_AMERICA, flagEmoji: "ðŸ‡²ðŸ‡½" },
  { name: "Colombia", slug: "colombia", code: "CO", region: Region.LATIN_AMERICA, flagEmoji: "ðŸ‡¨ðŸ‡´" },
  { name: "Brazil", slug: "brazil", code: "BR", region: Region.LATIN_AMERICA, flagEmoji: "ðŸ‡§ðŸ‡·" },
  { name: "Portugal", slug: "portugal", code: "PT", region: Region.EUROPE, flagEmoji: "ðŸ‡µðŸ‡¹" },
  { name: "Georgia", slug: "georgia", code: "GE", region: Region.EUROPE, flagEmoji: "ðŸ‡¬ðŸ‡ª" },
  { name: "Spain", slug: "spain", code: "ES", region: Region.EUROPE, flagEmoji: "ðŸ‡ªðŸ‡¸" },
  { name: "Germany", slug: "germany", code: "DE", region: Region.EUROPE, flagEmoji: "ðŸ‡©ðŸ‡ª" },
  { name: "Morocco", slug: "morocco", code: "MA", region: Region.MIDDLE_EAST_AFRICA, flagEmoji: "ðŸ‡²ðŸ‡¦" },
  { name: "India", slug: "india", code: "IN", region: Region.ASIA, flagEmoji: "ðŸ‡®ðŸ‡³" },
  { name: "Nepal", slug: "nepal", code: "NP", region: Region.ASIA, flagEmoji: "ðŸ‡³ðŸ‡µ" },
  { name: "Thailand", slug: "thailand", code: "TH", region: Region.ASIA, flagEmoji: "ðŸ‡¹ðŸ‡­" },
  { name: "Vietnam", slug: "vietnam", code: "VN", region: Region.ASIA, flagEmoji: "ðŸ‡»ðŸ‡³" },
  { name: "Indonesia", slug: "indonesia", code: "ID", region: Region.ASIA, flagEmoji: "ðŸ‡®ðŸ‡©" },
  { name: "Philippines", slug: "philippines", code: "PH", region: Region.ASIA, flagEmoji: "ðŸ‡µðŸ‡­" },
  { name: "Japan", slug: "japan", code: "JP", region: Region.ASIA, flagEmoji: "ðŸ‡¯ðŸ‡µ" },
  { name: "South Korea", slug: "south-korea", code: "KR", region: Region.ASIA, flagEmoji: "ðŸ‡°ðŸ‡·" },
  { name: "Australia", slug: "australia", code: "AU", region: Region.OCEANIA, flagEmoji: "ðŸ‡¦ðŸ‡º" },
  { name: "New Zealand", slug: "new-zealand", code: "NZ", region: Region.OCEANIA, flagEmoji: "ðŸ‡³ðŸ‡¿" },
];
...
const cities: SeedCity[] = [
  // NORTH AMERICA
  {
    ...
    description: "The city that never sleeps â€” overwhelming at first, liberating once you find your rhythm. Solo travel here means infinite anonymity and world-class everything.",
  ...
  },
  {
    ...
    countrySlug: "united-states",
    region: Region.NORTH_AMERICA,
    description: "Keep Portland weird â€” and solo travel here is exactly that. A city that celebrates individuality, with incredible coffee shops, forests, and an unusually friendly solo scene.",
    ...
    spots: [
      { name: "Powell's Books", slug: "powells-books", category: SpotCategory.CULTURE, description: "The world's largest independent bookstore. A solo traveler's heaven â€” get lost for hours, strike up a conversation, leave with armfuls of books.", address: "1005 W Burnside St, Portland", priceRange: PriceRange.FREE, tags: ["books", "free", "iconic", "rainy-day"] },
      { name: "Forest Park", slug: "forest-park", category: SpotCategory.NATURE, description: "One of the largest urban forests in the US. 80+ miles of trails, all within city limits â€” ideal for a solo reset hike.", address: "NW 29th Ave & Upshur St, Portland", priceRange: PriceRange.FREE, tags: ["hiking", "free", "forest", "solo-hike"] },
  ...
  // LATIN AMERICA
  {
    ...
    spots: [
      { name: "CafÃ© Avellaneda", slug: "cafe-avellaneda", category: SpotCategory.CAFE, description: "Third-wave specialty coffee in CoyoacÃ¡n, one of the city's most charming neighborhoods. Solo travelers are regulars here.", address: "Higuera 40, CoyoacÃ¡n, CDMX", priceRange: PriceRange.BUDGET, tags: ["specialty-coffee", "wifi", "coyoacan"] },
      { name: "Museo Frida Kahlo", slug: "museo-frida-kahlo", category: SpotCategory.CULTURE, description: "The Blue House where Frida Kahlo was born and died. One of the most emotionally resonant museum experiences in the world for a solo traveler.", address: "Londres 247, CoyoacÃ¡n, CDMX", priceRange: PriceRange.MID, tags: ["art", "iconic", "inspiring", "book-ahead"] },
      { name: "El Parnita", slug: "el-parnita", category: SpotCategory.FOOD, description: "Standing-room tacos in Colonia Roma. Arguably the best tacos in CDMX and the cheapest meal you'll eat all week.", address: "YucatÃ¡n 84, Roma Norte, CDMX", priceRange: PriceRange.BUDGET, tags: ["tacos", "street-food", "cheap", "iconic"] },
    ],
  },
  {
    name: "MedellÃ­n",
    ...
    region: Region.LATIN_AMERICA,
    description: "From the most dangerous city in the world to one of the most innovative â€” MedellÃ­n's transformation is one of the great urban stories. Solo travelers adore its eternal spring climate and creative energy.",
    lat: 6.2442, lng: -75.5812,
    timezone: "America/Bogota", currency: "COP", language: "Spanish",
    safetyScore: 6, costLevel: CostLevel.BUDGET,
    tags: ["digital-nomad", "innovation", "affordable", "nightlife", "warm-weather"],
    spots: [
      { name: "Selina MedellÃ­n", slug: "selina-medellin", category: SpotCategory.COWORKING, description: "Selina's MedellÃ­n outpost combines accommodation and coworking in one. The community mix of solo travelers and remote workers is excellent.", address: "Calle 9 #37-20, El Poblado, MedellÃ­n", priceRange: PriceRange.MID, tags: ["coworking", "community", "wifi", "nomad-hub"] },
      { name: "Parque ArvÃ­", slug: "parque-arvi", category: SpotCategory.NATURE, description: "A 16,000-hectare nature reserve accessible by the famous MedellÃ­n cable car. The cable car ride alone is worth the trip.", address: "Corregimiento Santa Elena, MedellÃ­n", priceRange: PriceRange.BUDGET, tags: ["nature", "cable-car", "hiking", "views"] },
      { name: "Pergamino CafÃ©", slug: "pergamino-cafe", category: SpotCategory.CAFE, description: "Colombia's best specialty coffee shop â€” and it's in MedellÃ­n. A pilgrimage spot for coffee lovers who travel solo.", address: "Carrera 37 #8A-37, El Poblado", priceRange: PriceRange.MID, tags: ["specialty-coffee", "wifi", "must-visit"] },
    ],
  },
  {
    name: "Rio de Janeiro",
    ...
    countrySlug: "brazil",
    region: Region.LATIN_AMERICA,
    description: "Rio is overwhelming in every sense â€” the beauty, the energy, the music. Solo travel here rewards the brave. Go for the beaches, stay for the samba.",
    ...
    spots: [
      { name: "Ipanema Beach", slug: "ipanema-beach", category: SpotCategory.NATURE, description: "One of the world's most famous beaches â€” and a genuinely social spot for solo travelers. Pick a posto (section), lay down a towel, and the beach does the rest.", address: "Praia de Ipanema, Rio de Janeiro", priceRange: PriceRange.FREE, tags: ["beach", "free", "social", "iconic"] },
      { name: "Casa Amarelo Hostel", slug: "casa-amarelo-hostel", category: SpotCategory.ACCOMMODATION, description: "One of Rio's best-rated hostels for solo travelers â€” the Yellow House in Santa Teresa, the city's arty bohemian neighborhood.", address: "R. Ãurea 80, Santa Teresa, Rio", priceRange: PriceRange.BUDGET, tags: ["hostel", "social", "santa-teresa", "budget"] },
      { name: "AprazÃ­vel", slug: "aprazivel", category: SpotCategory.FOOD, description: "A stunning hilltop restaurant in Santa Teresa with incredible views of the city. Splurge-worthy for a solo dinner.", address: "R. AprazÃ­vel 62, Santa Teresa, Rio", priceRange: PriceRange.HIGH, tags: ["splurge", "views", "dinner", "solo-table"] },
    ],
  },
  // EUROPE
  {
    ...
    description: "Europe's sunniest capital is also its most solo-travel-friendly. Small enough to walk everywhere, big enough to never get bored. Fado music and pastÃ©is de nata will rearrange your soul.",
    ...
    spots: [
      ...
      { name: "LX Factory", slug: "lx-factory", category: SpotCategory.COMMUNITY, description: "A repurposed industrial complex that's become Lisbon's creative hub. Solo travelers gravitate here â€” there's always something happening.", address: "R. Rodrigues de Faria 103, Lisbon", priceRange: PriceRange.FREE, tags: ["creative", "market", "community", "weekend"], website: "https://www.lxfactory.com", phone: "+351 213 143 399", googleMapsUrl: "https://www.google.com/maps/search/LX+Factory+Lisbon" },
      { name: "Home Lisbon Hostel", slug: "home-lisbon-hostel", category: SpotCategory.ACCOMMODATION, description: "Consistently rated one of the world's best hostels. Family-style dinners nightly â€” solo travelers leave with friends.", address: "R. de SÃ£o Nicolau 13, Baixa, Lisbon", priceRange: PriceRange.BUDGET, tags: ["top-rated", "social", "family-dinner", "solo-classic"], website: "https://www.homelisbonhostel.com", phone: "+351 218 885 312", googleMapsUrl: "https://www.google.com/maps/search/Home+Lisbon+Hostel+Baixa+Lisbon" },
      { name: "Mercado da Ribeira", slug: "mercado-da-ribeira", category: SpotCategory.FOOD, description: "Lisbon's iconic food hall inside the old riverside market. 35 stalls from the city's best chefs. Perfect for solo dining â€” just grab a seat at the communal tables.", address: "Av. 24 de Julho, Cais do SodrÃ©, Lisbon", priceRange: PriceRange.MID, tags: ["food-hall", "communal", "local-chefs", "riverside"], website: "https://www.timeoutmarket.com/lisboa", phone: "+351 210 607 403", googleMapsUrl: "https://www.google.com/maps/search/Time+Out+Market+Mercado+da+Ribeira+Lisbon" },
      { name: "Selina Secret Garden Lisbon", slug: "selina-secret-garden-lisbon", category: SpotCategory.COWORKING, description: "A beautiful coworking space inside a 19th-century palace. One of the best work setups in Lisbon â€” fast WiFi, private phone booths, and a courtyard that makes Zoom calls feel luxurious.", address: "R. de SÃ£o Bento 508, Lisbon", priceRange: PriceRange.MID, tags: ["coworking", "palace", "wifi", "nomad-friendly"], website: "https://www.selina.com/portugal/secret-garden-lisbon", phone: "+351 213 473 545", googleMapsUrl: "https://www.google.com/maps/search/Selina+Secret+Garden+Lisbon" },
  ...
  },
  {
    ...
    spots: [
      { name: "Abanotubani Sulphur Baths", slug: "abanotubani-sulphur-baths", category: SpotCategory.WELLNESS, description: "Natural sulphur hot springs built into Tbilisi's old town. Rent a private room for a solo soak â€” one of the most relaxing experiences in the Caucasus.", address: "Abanotubani District, Tbilisi", priceRange: PriceRange.BUDGET, tags: ["bath", "wellness", "authentic", "must-do"] },
  ...
  },
  {
    ...
    countrySlug: "spain",
    region: Region.EUROPE,
    description: "Architecture, beaches, food markets, and a nightlife scene that starts at midnight. Barcelona is endlessly stimulating for solo travelers â€” you'll never be bored, and you'll never be lonely.",
    ...
    spots: [
      ...
      { name: "Sagrada FamÃ­lia", slug: "sagrada-familia", category: SpotCategory.CULTURE, description: "GaudÃ­'s unfinished masterpiece â€” mind-bending from outside, transcendent from inside. Book solo tickets in advance; the interior is an otherworldly solo experience.", address: "C/ de Mallorca 401, Barcelona", priceRange: PriceRange.MID, tags: ["must-see", "architecture", "iconic", "book-ahead"] },
      { name: "Generator Barcelona", slug: "generator-barcelona", category: SpotCategory.ACCOMMODATION, description: "One of Europe's best design hostels â€” rooftop bar, social common areas, and a great mix of solo travelers. Walking distance from everything.", address: "C/ de CÃ²rsega 373, Barcelona", priceRange: PriceRange.BUDGET, tags: ["design-hostel", "rooftop", "social", "central"] },
    ],
  },
  {
    name: "Berlin",
    ...
    countrySlug: "germany",
    region: Region.EUROPE,
    description: "Berlin doesn't care who you are or where you came from â€” it just wants you to be yourself. The most accepting city in Europe for solo travelers, with history around every corner and a creative scene unlike anywhere else.",
    ...
    spots: [
      { name: "East Side Gallery", slug: "east-side-gallery", category: SpotCategory.CULTURE, description: "The longest remaining stretch of the Berlin Wall, now an open-air gallery. One of the most powerful solo walks in the world.", address: "MÃ¼hlenstraÃŸe 3-100, Friedrichshain, Berlin", priceRange: PriceRange.FREE, tags: ["history", "free", "art", "iconic", "walking"] },
      { name: "Roamers", slug: "roamers", category: SpotCategory.CAFE, description: "A beloved NeukÃ¶lln cafe with incredible brunch and the kind of relaxed energy that makes you stay three hours longer than planned.", address: "PannierstraÃŸe 64, NeukÃ¶lln, Berlin", priceRange: PriceRange.MID, tags: ["brunch", "wifi", "neukolln", "chill"] },
      { name: "Circus Hostel", slug: "circus-hostel", category: SpotCategory.ACCOMMODATION, description: "Berlin's best-loved hostel for solo travelers â€” central, social, and with an excellent bar. Legendary free walking tours depart from here.", address: "Weinbergsweg 1A, Mitte, Berlin", priceRange: PriceRange.BUDGET, tags: ["top-rated", "central", "social", "walking-tour"] },
    ],
  },
  // MIDDLE EAST & AFRICA
  {
    ...
    description: "Sensory overload in the best possible way. The medina, the souks, the riads â€” Marrakech is unlike anywhere else on earth and rewards solo travelers with the full depth of its chaos and beauty.",
  ...
  },
  {
    ...
    spots: [
      { name: "Thamel", slug: "thamel", category: SpotCategory.COMMUNITY, description: "Kathmandu's legendary traveler district â€” a maze of trekking shops, rooftop bars, and guesthouses where every solo traveler in Nepal eventually meets every other solo traveler.", address: "Thamel District, Kathmandu", priceRange: PriceRange.FREE, tags: ["hub", "social", "trekking-gear", "nightlife"] },
      { name: "Pashupatinath Temple", slug: "pashupatinath-temple", category: SpotCategory.CULTURE, description: "The most sacred Hindu temple complex in Nepal. Watch the evening Aarti ceremony on the banks of the Bagmati river â€” a solo traveler experience you'll never forget.", address: "Pashupatinath, Kathmandu", priceRange: PriceRange.BUDGET, tags: ["spiritual", "hindu", "ceremony", "unmissable"] },
      { name: "Roadhouse CafÃ©", slug: "roadhouse-cafe", category: SpotCategory.CAFE, description: "The best WiFi in Thamel, excellent wood-fired pizza, and a reliable spot for solo travelers to work, plan treks, and meet other travelers.", address: "Thamel Marg, Thamel, Kathmandu", priceRange: PriceRange.BUDGET, tags: ["wifi", "pizza", "work-friendly", "thamel"] },
    ],
  },
  // SOUTHEAST ASIA
  {
    ...
    spots: [
      ...
      { name: "Zoe in Yellow", slug: "zoe-in-yellow", category: SpotCategory.NIGHTLIFE, description: "The solo traveler's unofficial meeting point every night in Chiang Mai. Not fancy â€” just the right energy, cheap drinks, and everyone's alone and okay with it.", address: "Ratchaphakhinai Rd, Old City, Chiang Mai", priceRange: PriceRange.BUDGET, tags: ["social", "cheap", "meeting-point", "backpacker"], googleMapsUrl: "https://www.google.com/maps/search/Zoe+in+Yellow+Chiang+Mai" },
      ...
      { name: "Khao Soi Khun Yai", slug: "khao-soi-khun-yai", category: SpotCategory.FOOD, description: "The best khao soi in Chiang Mai â€” and that is saying something in the city that invented it. A tiny local shop, outdoor tables, insane coconut curry noodle soup for under $2.", address: "Charoen Prathet Rd, Chang Khlan, Chiang Mai", priceRange: PriceRange.BUDGET, tags: ["khao-soi", "local", "must-eat", "cheap", "authentic"], googleMapsUrl: "https://www.google.com/maps/search/Khao+Soi+Khun+Yai+Chiang+Mai" },
      { name: "Mad Monkey Hostel Chiang Mai", slug: "mad-monkey-hostel-chiang-mai", category: SpotCategory.ACCOMMODATION, description: "The most social hostel in Chiang Mai â€” rooftop pool, daily events, a bar that becomes the meeting point for every solo traveler in the city. Hard to leave.", address: "47/1 Ratchapakinai Rd, Old City, Chiang Mai", priceRange: PriceRange.BUDGET, tags: ["hostel", "pool", "social", "rooftop", "events"], website: "https://www.madmonkeyhostels.com/chiang-mai", phone: "+66 52 003 008", googleMapsUrl: "https://www.google.com/maps/search/Mad+Monkey+Hostel+Chiang+Mai" },
      ...
      { name: "Lila Thai Massage", slug: "lila-thai-massage", category: SpotCategory.WELLNESS, description: "Traditional Thai massage run by female ex-prisoners as part of a rehabilitation program. Genuinely excellent massages and a social enterprise worth supporting â€” 1 hour for 280 baht.", address: "Arak Rd, Old City, Chiang Mai", priceRange: PriceRange.BUDGET, tags: ["massage", "wellness", "social-enterprise", "cheap", "authentic"], website: "https://www.lilamassage.com", phone: "+66 53 281 325", googleMapsUrl: "https://www.google.com/maps/search/Lila+Thai+Massage+Chiang+Mai" },
    ],
  },
  {
    name: "Há»™i An",
    ...
    countrySlug: "vietnam",
    region: Region.ASIA,
    description: "Vietnam's most beautiful town â€” a UNESCO-listed ancient trading port with yellow walls, lanterns, and a pace of life that makes every solo traveler slow down. Rent a bicycle and get lost.",
    ...
    spots: [
      { name: "Ancient Town", slug: "hoi-an-ancient-town", category: SpotCategory.CULTURE, description: "The UNESCO-protected old town is best explored alone on foot at dawn before the crowds arrive. The lantern-lit evenings are unforgettable.", address: "Há»™i An Ancient Town, Quáº£ng Nam", priceRange: PriceRange.BUDGET, tags: ["unesco", "walking", "lanterns", "dawn", "iconic"] },
      { name: "Morning Glory Restaurant", slug: "morning-glory-restaurant", category: SpotCategory.FOOD, description: "The legendary Há»™i An restaurant by chef Trinh Diem Vy. The White Rose dumplings are unmissable. Solo dining at the bar counter is the move.", address: "106 Nguyá»…n ThÃ¡i Há»c, Há»™i An", priceRange: PriceRange.MID, tags: ["must-eat", "local-cuisine", "famous", "counter-seating"] },
      { name: "Anantara Há»™i An Resort", slug: "anantara-hoi-an", category: SpotCategory.ACCOMMODATION, description: "For a solo splurge in Vietnam â€” a stunning riverside resort with gorgeous rooms and a pool that feels like your own. Worth every dong.", address: "1 Pháº¡m Há»“ng ThÃ¡i, Há»™i An", priceRange: PriceRange.HIGH, tags: ["luxury", "riverside", "pool", "splurge"] },
    ],
  },
  {
    name: "Bali",
    ...
    region: Region.ASIA,
    description: "Bali is the solo travel capital of the world â€” its entire tourism infrastructure is built around people who arrive alone and leave transformed. Ubud for the soul, Canggu for the laptop, Seminyak for the sunset.",
    ...
    spots: [
      { name: "Dojo Bali Coworking", slug: "dojo-bali", category: SpotCategory.COWORKING, description: "Canggu's most popular coworking space â€” pool, fast WiFi, coffee, and a community of digital nomads from every country. The easiest place to make solo travel friends.", address: "Jl. Batu Mejan No.88, Canggu, Bali", priceRange: PriceRange.MID, tags: ["coworking", "pool", "community", "canggu", "nomad"], website: "https://www.dojobali.org", phone: "+62 361 934 8388", googleMapsUrl: "https://www.google.com/maps/search/Dojo+Bali+Coworking+Canggu+Bali" },
      { name: "Tegalalang Rice Terraces", slug: "tegalalang-rice-terraces", category: SpotCategory.NATURE, description: "Bali's most photographed landscape â€” and genuinely breathtaking in person. Go early to have it almost to yourself.", address: "Tegalalang, Ubud, Bali", priceRange: PriceRange.BUDGET, tags: ["nature", "views", "instagram", "ubud", "sunrise"], googleMapsUrl: "https://www.google.com/maps/search/Tegalalang+Rice+Terraces+Ubud+Bali" },
  ...
  },
  {
    ...
    region: Region.ASIA,
    description: "The surfing capital of the Philippines â€” a tear-drop shaped island that's been discovered but not yet ruined. Cloud 9 wave, coconut roads, and an island community that pulls solo travelers in and never quite lets go.",
    ...
    spots: [
      { name: "Cloud 9 Surf Break", slug: "cloud-9-surf-break", category: SpotCategory.NATURE, description: "The world-class reef break that put Siargao on the map. Beginners can watch from the iconic boardwalk â€” experts will never want to leave.", address: "Cloud 9, General Luna, Siargao", priceRange: PriceRange.FREE, tags: ["surf", "iconic", "free", "views", "world-class"] },
      { name: "Kermit Surf & Dive Resort", slug: "kermit-resort", category: SpotCategory.ACCOMMODATION, description: "Siargao's most beloved surf resort â€” the communal vibe is perfect for solo travelers. Surfboard rental, beachside bar, and a Neapolitan pizza oven somehow.", address: "General Luna, Siargao", priceRange: PriceRange.MID, tags: ["surf-resort", "social", "pizza", "community"] },
      { name: "Magpupungko Rock Pools", slug: "magpupungko-rock-pools", category: SpotCategory.NATURE, description: "Natural rock pools carved by the ocean â€” a stunning solo day trip from General Luna. Only accessible at low tide, which makes it feel like a secret.", address: "Pilar, Siargao Island", priceRange: PriceRange.BUDGET, tags: ["nature", "swimming", "day-trip", "low-tide-only"] },
    ],
  },
  // EAST ASIA
  {
    ...
    countrySlug: "japan",
    region: Region.ASIA,
    description: "Japan's ancient capital rewards the solo traveler like nowhere else. Walk from temple to temple in complete comfortable silence â€” a city that not only accepts solo travel, it seems designed for it.",
    ...
    spots: [
      ...
      { name: "Weekenders Coffee", slug: "weekenders-coffee", category: SpotCategory.CAFE, description: "One of Kyoto's best specialty coffee roasters â€” intimate, beautiful space in NakagyÅ Ward. Perfect for a solo morning in the city.", address: "Jingumichi-kado, NakagyÅ Ward, Kyoto", priceRange: PriceRange.MID, tags: ["specialty-coffee", "beautiful", "solo-friendly", "roaster"], website: "https://www.weekenderscoffee.com", googleMapsUrl: "https://www.google.com/maps/search/Weekenders+Coffee+Kyoto" },
      { name: "Gion Hatanaka", slug: "gion-hatanaka", category: SpotCategory.ACCOMMODATION, description: "A traditional machiya townhouse experience in Gion. Expensive but transformative â€” the solo travel splurge of a lifetime in Japan.", address: "Shinmonzen-dori, Gion, Kyoto", priceRange: PriceRange.HIGH, tags: ["traditional", "gion", "splurge", "authentic", "machiya"], website: "https://www.hatanaka.co.jp/en", phone: "+81 75 551 0335", googleMapsUrl: "https://www.google.com/maps/search/Gion+Hatanaka+Ryokan+Kyoto" },
      { name: "Nishiki Market", slug: "nishiki-market", category: SpotCategory.FOOD, description: "Kyoto's five-block covered food market, nicknamed 'Kyoto's Kitchen'. Hundreds of stalls selling pickles, tofu, fresh fish, and street snacks. Solo eating heaven â€” everything is single-serving.", address: "Nishiki Market, Nakagyo, Kyoto", priceRange: PriceRange.BUDGET, tags: ["market", "street-food", "local", "morning", "solo-dining"], googleMapsUrl: "https://www.google.com/maps/search/Nishiki+Market+Kyoto" },
      { name: "Arashiyama Bamboo Grove", slug: "arashiyama-bamboo-grove", category: SpotCategory.NATURE, description: "The iconic bamboo forest on the western edge of Kyoto. Walk through it alone at 6am before the crowds arrive â€” the sound of wind through the bamboo is unlike anything else on earth.", address: "Sagaogurayama Tabuchiyamacho, Arashiyama, Kyoto", priceRange: PriceRange.FREE, tags: ["bamboo", "free", "early-morning", "photography", "iconic"], googleMapsUrl: "https://www.google.com/maps/search/Arashiyama+Bamboo+Grove+Kyoto" },
      ...
      { name: "Hello CafÃ© Kyoto", slug: "hello-cafe-kyoto", category: SpotCategory.COWORKING, description: "A quietly excellent work cafÃ© near Kyoto Station â€” laptops welcome, fast WiFi, great matcha, minimal noise. One of the few genuinely nomad-friendly spots in a city that doesn't usually cater to remote work.", address: "Shimogyo, Kyoto", priceRange: PriceRange.BUDGET, tags: ["coworking", "wifi", "matcha", "quiet", "nomad-friendly"], googleMapsUrl: "https://www.google.com/maps/search/Hello+Cafe+Kyoto+coworking" },
      { name: "Pontocho Alley", slug: "pontocho-alley", category: SpotCategory.NIGHTLIFE, description: "Kyoto's narrow lantern-lit dining alley running parallel to the Kamo River. The best solo evening in the city â€” pick a restaurant with a river-facing terrace, order omakase, and watch Kyoto glow.", address: "Pontocho, Nakagyo, Kyoto", priceRange: PriceRange.HIGH, tags: ["dinner", "lanterns", "riverside", "atmosphere", "evening"], googleMapsUrl: "https://www.google.com/maps/search/Pontocho+Alley+Kyoto" },
    ],
  },
  {
    name: "Seoul",
    ...
    region: Region.ASIA,
    description: "Seoul is relentlessly modern and surprisingly easy to navigate solo â€” the subway system is a miracle and the food on every corner is extraordinary. K-culture, hiking trails through the city, and 24-hour everything.",
  ...
  // OCEANIA
  {
    ...
    description: "Australia's cultural capital â€” a city of incredible coffee, laneway street art, world-class restaurants, and a population that genuinely enjoys being alone in public. Solo travel here feels completely natural.",
  ...
  },
  {
    ...
    region: Region.OCEANIA,
    description: "The adventure capital of the world â€” bungee jumping, skydiving, and skiing, all against the backdrop of the Remarkables mountain range. Solo travelers come for the adrenaline and are stunned by the beauty.",
    ...
    spots: [
      { name: "AJ Hackett Kawarau Bridge Bungy", slug: "kawarau-bungy", category: SpotCategory.NATURE, description: "The original commercial bungee jump â€” 43 metres over the Kawarau River. Doing this alone is a rite of passage and a genuine leap of faith.", address: "202 Bungy Centre, Kawarau Gorge, Queenstown", priceRange: PriceRange.HIGH, tags: ["bungee", "adventure", "iconic", "solo-challenge"] },
  ...
  // BONUS CITIES
  {
    ...
    countrySlug: "australia",
    region: Region.OCEANIA,
    description: "Australia's wellness capital â€” a surf town turned spiritual retreat hub. The solo travelers who come for a weekend often stay for months. The Cape Byron lighthouse walk at sunrise is non-negotiable.",
    ...
    spots: [
      { name: "Cape Byron Lighthouse Walk", slug: "cape-byron-lighthouse-walk", category: SpotCategory.NATURE, description: "Australia's most easterly point â€” the sunrise walk from town to the lighthouse is one of the great solo travel moments in the country.", address: "Cape Byron Headland Reserve, Byron Bay", priceRange: PriceRange.FREE, tags: ["sunrise", "free", "walk", "views", "solo-perfect"] },
...
async function main() {
  console.log("ðŸŒ Seeding SouloSpotter database...");
  ...
  console.log(`âœ… ${countries.length} countries seeded`);
  ...
  // â”€â”€â”€ Seed Experiences â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  console.log(`âœ… ${cityCount} cities seeded`);
  console.log(`âœ… ${spotCount} spots seeded`);
  console.log(`âœ… ${experienceCount} experiences seeded`);
