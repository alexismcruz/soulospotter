...
const countries = [
  ...
  { name: "Morocco", slug: "morocco", code: "MA", region: Region.AFRICA, flagEmoji: "🇲🇦" },
  { name: "India", slug: "india", code: "IN", region: Region.ASIA, flagEmoji: "🇮🇳" },
  { name: "Nepal", slug: "nepal", code: "NP", region: Region.ASIA, flagEmoji: "🇳🇵" },
  { name: "Thailand", slug: "thailand", code: "TH", region: Region.ASIA, flagEmoji: "🇹🇭" },
  { name: "Vietnam", slug: "vietnam", code: "VN", region: Region.ASIA, flagEmoji: "🇻🇳" },
  { name: "Indonesia", slug: "indonesia", code: "ID", region: Region.ASIA, flagEmoji: "🇮🇩" },
  { name: "Philippines", slug: "philippines", code: "PH", region: Region.ASIA, flagEmoji: "🇵🇭" },
  { name: "Japan", slug: "japan", code: "JP", region: Region.ASIA, flagEmoji: "🇯🇵" },
  { name: "South Korea", slug: "south-korea", code: "KR", region: Region.ASIA, flagEmoji: "🇰🇷" },
