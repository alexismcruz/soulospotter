...
const cities: SeedCity[] = [
  ...
  // EUROPE
  {
    ...
    spots: [
      ...
      { name: "Mercado da Ribeira", slug: "mercado-da-ribeira", category: SpotCategory.FOOD, description: "Lisbon's iconic food hall inside the old riverside market. 35 stalls from the city's best chefs. Perfect for solo dining — just grab a seat at the communal tables.", address: "Av. 24 de Julho, Cais do Sodré, Lisbon", priceRange: PriceRange.MID, tags: ["food-hall", "communal", "local-chefs", "riverside"] },
